...
path = "C:/Users/josh.fullmer/Documents/Data Migration/Heather Pettit/api/"
name = "leads"
ext = ".json"
...
puts "Write to CSV"
CSV.open("#{path}#{name}.csv", 'w', headers:true) do |csv|
